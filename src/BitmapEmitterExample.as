...
package
{
     ...
     */
    public class BitmapEmitterExample extends ExampleBase
    {
        private var emitter:Emitter2D = new Emitter2D();

        public function BitmapEmitterExample()
        {
            super();
        }
        ...
        override protected function addedToStageHandler(event:Event):void
        {
            ...
            var renderer:BitmapRenderer = new BitmapRenderer(new Rectangle(0, 0, stage.stageWidth, stage.stageHeight), false);
            addChild( renderer );
