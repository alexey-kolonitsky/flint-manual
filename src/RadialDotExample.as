package
{
     ...
     */
    public class RadialDotExample extends ExampleBase
    {
        private var emitter:DriftStarsEmitter;
        private var renderer:SpriteRendererBase;

        public function RadialDotExample()
        {
            super();
        }
        ...
        override protected function addedToStageHandler(event:Event):void
        {
            ...
            emitter = new DriftStarsEmitter(start, canvas, new ImageClass(RadialDot, [4], true));
